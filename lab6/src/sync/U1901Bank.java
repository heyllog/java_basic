...
public class U1901Bank {
    ...
    public synchronized void calc(int intTransaction, long lngTimeout) {
        System.out.println("before Thread=" + Thread.currentThread().getName() + ", From=" + this.getIntFrom() + ", To=" + this.getIntTo());
        ...
        System.out.println("after Thread=" + Thread.currentThread().getName() + ", From=" + this.getIntFrom() + ", To=" + this.getIntTo());
    }
}
